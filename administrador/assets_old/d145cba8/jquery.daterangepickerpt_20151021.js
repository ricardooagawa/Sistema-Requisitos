...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		presetRanges: [
			...
			{text: 'Começo do mês até Hoje', dateStart: function(){ return Date.parse('today').moveToFirstDayOfMonth();  }, dateEnd: 'today' },
			{text: 'Começo do ano até Hoje', dateStart: function(){ var x= Date.parse('today'); x.setMonth(0); x.setDate(1); return x; }, dateEnd: 'today' },
			//extras:
		...
		presets: {
			...
			allDatesAfter: 'Todas as datas após', 
			dateRange: 'Intervalo de datas'
		},
		rangeStartTitle: 'Data de Início',
		rangeEndTitle: 'Data de Término',
		nextLinkText: 'Próximo',
		prevLinkText: 'Anterior',
		doneButtonText: 'Pronto',
