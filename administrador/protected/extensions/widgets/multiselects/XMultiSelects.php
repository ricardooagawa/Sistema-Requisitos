...
class XMultiSelects extends CWidget
{
	...
	public $rightName;
	/**
	 * The id for the left mutiple select
	 * require
	 * @var string
	 */
	public $leftId='select_left';
	/**
	 * The id for the right mutiple select
	 * require
	 * @var string
	 */
	public $rightId='select_right';
	/**
	...
	public function run()
	{
		...
		echo "<select name=\"{$this->leftName}\" id=\"{$this->leftId}\" multiple=\"multiple\" size=\"{$this->size}\" style=\"width:{$this->width}\">\n";
		...
		echo "<select name=\"{$this->rightName}\" id=\"{$this->rightId}\" multiple=\"multiple\" size=\"{$this->size}\" style=\"width:{$this->width}\">\n";
