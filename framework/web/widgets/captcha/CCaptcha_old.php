...
class CCaptcha extends CWidget
{
	 ...
	 */
	public $imageOptions=array('align'=>'middle');
	/**
	...
	public function registerClientScript()
	{
		...
		{
			$imagem=Yii::app()->CreateUrl('images/recaptcha.png');
			$imagem=str_replace(Yii::app()->language.'/','',$imagem);
			$imagem=str_replace('index.php/','',$imagem);
			$cs->registerScript('Yii.CCaptcha#'.$id,'dummy');
			//$label=$this->buttonLabel===null?Yii::t('botoes','Captcha'):$this->buttonLabel;
			$label=$this->buttonLabel===null?CHtml::image($imagem,'',array('width'=>13)):$this->buttonLabel;
